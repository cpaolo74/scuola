...
// Import Models
import { Exam } from '../../domain/scuola_db/exam';
import { Course } from '../../domain/scuola_db/course';
import { Student } from '../../domain/scuola_db/student';
import { Teacher } from '../../domain/scuola_db/teacher';
...
*	@description questa Api serve per validare gli esami
*	@param String id id esami
*	@returns Boolean
*
*/
// END - USED SERVICES
